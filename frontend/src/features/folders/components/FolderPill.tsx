...
import { Folder, MoreVert, EditPencil, Trash } from "iconoir-react";
import { cn } from "@/lib/utils";
import { FOLDER_COLORS } from "../hooks";
...
export function FolderPill({ name, color, count, isActive, onClick, onEdit, onDelete, onDrop, showActions }: FolderPillProps) {
