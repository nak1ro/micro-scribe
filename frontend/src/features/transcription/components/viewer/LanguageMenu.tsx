...
import { useLanguageMenu, UseLanguageMenuProps } from "@/features/transcription/hooks/useLanguageMenu";
        ...
        <div ref={menuRef} className={cn("relative", className)}>
            ...
            >
                ...
                <div className="flex items-center gap-1.5">
                    ...
                    <NavArrowDown className={cn("h-4 w-4 text-muted-foreground transition-transform duration-200", isOpen && "rotate-180")} />
                </div>
            </button>
            ...
            {isOpen && (
                <div
                    className="absolute top-full left-0 right-0 mt-1 z-50 bg-popover border border-border rounded-lg shadow-lg py-1 animate-fade-in max-h-80 overflow-y-auto"
                    role="menu"
                    id={menuId}
                >
                    {/* Original language */}
