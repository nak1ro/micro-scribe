        ...
        <>
            ...
            <div
                ...
                className={cn(
                    ...
                    "rounded-md px-0.5 py-0.5 -mx-0.5",
                    // Normal mode styles
            ...
            >
                {/* Timestamp pill */}
                {showTimecode && (
                    <span className="inline-flex items-center justify-center bg-primary/10 text-primary font-medium text-sm rounded-full px-2 py-px mr-1.5 -my-px -translate-y-px">
